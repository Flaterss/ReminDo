...
import com.example.remindo.adapter.ViewPagerAdapter;
...
public class TutorScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirstTime.equals("YES")) {
            Intent i = new Intent(TutorScreen.this, SignIn.class);
            startActivity(i);
            finish();
        } else {
    ...
    public void setUpindicator(int position){
        ...
        for (int i = 0 ; i < dots.length ; i++){
            ...
            dots[i].setTextColor(getResources().getColor(R.color.cyan,getApplicationContext().getTheme()));
